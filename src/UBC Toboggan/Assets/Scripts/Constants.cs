...
namespace Constants 
{
    public class Prompts 
    {
        ...
        public static string PauseMenuControllerExitPrompt = "<voffset=0.3em><sprite=\"Option\" anim=\"0,3,8\"></voffset> to return to game, <voffset=0.5em><sprite=\"Cross\" anim=\"0,3,8\"></voffset> to restart,\nand  <voffset=0.1em><sprite=\"Circle\" anim=\"0,3,8\"></voffset>to quit game";
        ...
        public static string MainMenuKeyboardControlsPrompt =  string.Format("{0}\n<pos=5%><size=200%><voffset=-0.2em><sprite=\"ENTER\" anim=\"0,2,6\"></voffset></size> Pause", PauseMenuKeyboardControlsPrompt);
    ...
    public class Scenes
    {
        ...
        public static string Results = "ResultsScreen";
    }
}
